...
export const GeneralLayout: FC<GeneralLayoutProps> = ({
  ...
  return (
    <div className="h-screen bg-softGreen">
      ...
      <div className="w-full p-0 bg-softGreen h-[96dvh]">
        <div className="mx-auto w-full border-l border-r border-stroke bg-white p-4 tablet:p-6 desktop:w-[1200px] h-[96dvh]">
